...
if __name__ == '__main__':
    parameter_sweep = {'seed': range(12345, 12345+50),
                       ...
                       'per_HH_adapted_to_SN_prob_midpoint': [0.3],
                       'weight_SN_vs_PMT': [0.8], #'empirical'
    ...
    results_df.to_csv('../results/model_data_empirical_potential.csv')
