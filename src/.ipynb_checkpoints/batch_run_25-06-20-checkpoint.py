...
if __name__ == '__main__':
    parameter_sweep = {'seed': range(12345, 12345+50),
                       ...
                       'consider_measure_every_x_steps': [1, 2, 3, 4, 5, 8],
    ...
    model_results.to_csv('/scratch/thoridwagenbla/model_data_250620.csv')
    ...
    agent_results.to_csv('/scratch/thoridwagenbla/agent_data_250620.csv')
